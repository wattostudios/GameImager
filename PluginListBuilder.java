...
**********************************************************************************************
**/
  public static PluginList[] getExportPluginList() {
    ArchivePlugin[] arcPlugins = getExportPlugins();
...
**********************************************************************************************
**/
  public static ArchivePlugin[] getExportPlugins() {
    WSPlugin[] plugins = WSPluginManager.group("Archive").getPlugins();
...
/**
**********************************************************************************************
Gets writable collections only
**********************************************************************************************
**/
...
**/
  public static ArchivePlugin[] getWritePlugins() {
    ...
    for (int i=0;i<plugins.length;i++){
      ArchivePlugin arcPlugin = (ArchivePlugin)plugins[i];
      if (arcPlugin.canWrite() && arcPlugin.isCollection()){
        writePlugins[numWritable] = arcPlugin;
        numWritable++;
        }
      }
...
**********************************************************************************************
**/
  public static PluginList[] getPalettePluginList() {
    PalettePlugin[] arcPlugins = getPalettePlugins();
    return getPluginList(arcPlugins);
    }
...
**********************************************************************************************
**/
  public static PalettePlugin[] getPalettePlugins() {
    WSPlugin[] plugins = WSPluginManager.group("Palette").getPlugins();

    if (plugins == null || plugins.length == 0){
      plugins = new PalettePlugin[0];
      }

    PalettePlugin[] plugs = new PalettePlugin[plugins.length];
    for (int i=0;i<plugins.length;i++){
      plugs[i] = (PalettePlugin)plugins[i];
      }
