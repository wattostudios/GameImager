...
**********************************************************************************************
**/
public class Options_General extends WSPanelPlugin {
...
**********************************************************************************************
**/
  public Options_General(XMLNode node){
    super(node);
    }
...
**/
  public void buildObject(XMLNode node){
    ...
    XMLNode srcNode = XMLReader.read(new File("settings" + File.separator + "interface_SidePanel_Options_General.wsd"));
