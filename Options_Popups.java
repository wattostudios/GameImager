...
**********************************************************************************************
**/
public class Options_Popups extends WSPanelPlugin {
...
**********************************************************************************************
**/
  public Options_Popups(XMLNode node){
    super(node);
    }
...
**/
  public void buildObject(XMLNode node){
    ...
    XMLNode srcNode = XMLReader.read(new File("settings" + File.separator + "interface_SidePanel_Options_Popups.wsd"));
...
**/
  public void sortCheckboxes(){
    WSPanel panel = (WSPanel)WSRepository.get("SidePanel_Options_Popups_Checkboxes");

    Component[] components = panel.getComponents();
    //WSOptionCheckBox[] checkboxes = new WSOptionCheckBox[components.length];
