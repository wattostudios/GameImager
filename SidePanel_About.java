...
**********************************************************************************************
**/
public class SidePanel_About extends WSPanelPlugin {
...
**********************************************************************************************
**/
  public SidePanel_About(XMLNode node){
    super(node);
    }
...
**/
  public void buildObject(XMLNode node){
    ...
    XMLNode srcNode = XMLReader.read(new File("settings" + File.separator + "interface_SidePanel_About.wsd"));
...
**/
  public void onCloseRequest(){
    WSCreditsPanel credits = (WSCreditsPanel)WSRepository.get("SidePanel_About_Credits");
    credits.stopScrollTimer();
    }
