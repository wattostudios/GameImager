...
**********************************************************************************************
**/
public class Palette_PAL_2 extends PalettePlugin {
...
**********************************************************************************************
**/
  public Palette_PAL_2() {
    super("PAL_2","PAL_2");

    //            read write
    setProperties(true,true);

    setGames("Pro Pinball: Big Race USA");
...
**/
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (check.numColors((int)(fm.length() / 3))){
        rating += 5;
        }
