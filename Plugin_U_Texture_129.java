...
**********************************************************************************************
**/
public class Plugin_U_Texture_129 extends ArchivePlugin {
...
**********************************************************************************************
**/
  public Plugin_U_Texture_129() {
    super("U_Texture_129","Unreal Engine 2.0 v1.29 Texture Image");
...
**/
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // 4 - Unknown (3)
      check.equals(fm.readIntL(),3);

      // 4 - null
      check.equals(fm.readIntL(),0);

      // 4 - Unknown (1)
      check.equals(fm.readIntL(),1);
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i=0;i<numMipmaps;i++){
        ...
        int dataLength = (int)Plugin_U_Texture_Generic_DDS.readIndex(fm);
...
**/
  public static void writeDXT1Pixels(FileManipulator fm, int[] pixels, int width, int height, int numMipmaps) throws Exception {
    ...
    // 1-5 - Image Data Length
    Plugin_U_Texture_Generic_DDS.writeIndex(fm,length);
