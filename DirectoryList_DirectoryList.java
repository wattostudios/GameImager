  ...
  public boolean onRightClick(JComponent c, java.awt.event.MouseEvent e){
    if (c == list){
      ...
      if (selectedFile.isDirectory()){
        ...
        // file
        menu.add(new WSMenuItem(XMLReader.readString("<WSMenuItem code=\"DirectoryList_RightClick_ReadArchive_Normal\" />")));
        menu.add(new WSMenuItem(XMLReader.readString("<WSMenuItem code=\"DirectoryList_RightClick_ReadArchive_OpenWith\" />")));
        menu.add(new WSPopupMenuSeparator(XMLReader.readString("<WSPopupMenuSeparator />")));
        menu.add(new WSMenuItem(XMLReader.readString("<WSMenuItem code=\"DirectoryList_RightClick_ParentDirectory\" />")));
        menu.add(new WSMenuItem(XMLReader.readString("<WSMenuItem code=\"DirectoryList_RightClick_Refresh\" />")));
        }
