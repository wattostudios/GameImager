...
**********************************************************************************************
**/
public class Plugin_1TXD_1TXD extends ArchivePlugin {
...
**********************************************************************************************
**/
  public Plugin_1TXD_1TXD() {
    super("1TXD_1TXD","1TXD_1TXD");
    ...
    setExtensions("1txd"); // MUST BE LOWER CASE
    setPlatforms("PC");
    }
...
**/
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // 4 - Header
      if (fm.readString(4).equals("1TXD")){
        rating += 50;
        }
      else {
        rating = 0;
