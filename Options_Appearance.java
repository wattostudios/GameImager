...
**********************************************************************************************
**/
public class Options_Appearance extends WSPanelPlugin {
...
**********************************************************************************************
**/
  public Options_Appearance(XMLNode node){
    super(node);
    }
...
**/
  public void buildObject(XMLNode node){
    ...
    XMLNode srcNode = XMLReader.read(new File("settings" + File.separator + "interface_SidePanel_Options_Appearance.wsd"));
