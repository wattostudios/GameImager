...
echo ==== Copy Complete ====
echo ==== Removing Full Version Features ====

del FullVersionVerifier.class /Q
del Task_ExportFiles.class /Q
del Task_RemoveFiles.class /Q
del Task_WriteArchive.class /Q
...
"C:\Program Files\Java\jdk1.6.0\bin\jar.exe" cmf _JarManifest.txt GameImager.jar *.class images org
"C:\Program Files\Java\jdk1.6.0\bin\jar.exe" cfM _release/imager.zip _Readme_GameImager.txt *.jar *.ico GameImager.bat openFile.bat help language logs settings temp updates *.exe
move GameImager.jar _release
